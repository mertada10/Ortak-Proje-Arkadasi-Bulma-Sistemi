...
// Canlıya çıkış (production): henüz geçerçek hata mesajları istemciye sızmamaz.
// APP_ENV=production ayarılandığında display_errors olasıdur; yapı bilgisi
// yalnızca sunucu log'larda kalanır.
