                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                ...
                                                <a href="projects.php?action=delete&id=<?= $p["id"] ?>" class="btn btn-delete" onclick="return confirm('Bu proje ilanını silmek istediğinize emin misiniz?')" title="Projeyi Sil">
