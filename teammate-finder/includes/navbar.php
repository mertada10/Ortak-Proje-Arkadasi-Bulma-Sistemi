...
$stmt = $pdo->prepare("SHOW COLUMNS FROM requests LIKE 'sender_seen'");
$stmt->execute();

if ($stmt->rowCount() === 0) {
    $pdo->exec("ALTER TABLE requests ADD COLUMN sender_seen TINYINT(1) NOT NULL DEFAULT 0");
}
...
$requestResponseCount = $stmt->fetchColumn();
?>
    ...
    <?php if(isset($_SESSION["user_id"])): ?>
        ...
        <li class="dropdown">
            ...
            <a href="#" id="profileBtn">
                ...
                <?php $notificationCount = (int)$unreadCount + (int)$teamRequestCount + (int)$requestResponseCount; ?>
                <span id="profileNotificationBadge"
                      class="profile-notification-badge"
                      <?= $notificationCount > 0 ? '' : 'style="display:none;"' ?>>
                    <?= $notificationCount ?>
                </span>
            ...
            <ul class="dropdown-menu" id="profileMenu">
                ...
                <li>
                    <a href="/teammate-finder/pages/messages.php">
                        ...
                        <span id="messagesNotificationBadge"
                ...
                <li>
                    <a href="/teammate-finder/pages/requests.php">
                        ...
                        <?php $requestTotalBadge = (int)$teamRequestCount + (int)$requestResponseCount; ?>
                        <span id="requestsNotificationBadge"
                              class="notification-badge"
                              <?= $requestTotalBadge > 0 ? '' : 'style="display:none;"' ?>>
                            <?= $requestTotalBadge ?>
                        </span>
