...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["remove_member"])) {
    ...
    if ($member_id !== $user_id && $member_id !== $team["owner_id"]) {
    ...
    <div class="manage-team-shell">
        ...
        <div class="manage-header">
            <div>
                ...
                <p><strong><?= htmlspecialchars($team["team_name"]) ?></strong> takımı üyelerinin rollerini düzenleyebilir, liderliği devredebilir veya üyeleri takımdan çıkarabilirsiniz.</p>
            </div>
            <a href="team.php" class="back-team-btn">
                <i class="fa-solid fa-arrow-left"></i> Takıma Dön
            </a>
        </div>
