    ...
    <div class="manage-team-shell">
        ...
        <div class="manage-header">
            <div>
                ...
                <p><strong id="teamNameDisplay"><?= htmlspecialchars($team["team_name"]) ?></strong> takımı üyelerinin rollerini düzenleyebilir, takım adını güncelleyebilir veya üyeleri yönetebilirsiniz.</p>
            </div>
        ...
        <div class="team-name-editor">
            ...
            <form method="POST" class="editor-form" id="teamNameEditorForm" data-team-id="<?= (int)$team["id"] ?>">
                <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
                <input type="text" name="team_name" id="teamNameInput" value="<?= htmlspecialchars($team["team_name"]) ?>" required>
                ...
                <?php foreach ($members as $member): ?>
                    <div class="manage-member-card">
                        ...
                        <div class="manage-actions-group">
                            <form method="POST" class="inline-form role-action-form" data-member-id="<?= (int)$member["id"] ?>">
                                <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
                            ...
                            <form method="POST" class="inline-form transfer-form" data-member-id="<?= (int)$member["id"] ?>">
                                <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
                                <input type="hidden" name="member_id" value="<?= (int)$member["id"] ?>">
                            ...
                            <form method="POST" class="inline-form remove-member-form" data-member-id="<?= (int)$member["id"] ?>">
                                <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
                                <input type="hidden" name="member_id" value="<?= (int)$member["id"] ?>">
