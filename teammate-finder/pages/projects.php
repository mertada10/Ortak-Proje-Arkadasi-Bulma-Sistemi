    ...
    <div class="project-grid">
        <?php if (count($myProjects) > 0): ?>
            <?php foreach ($myProjects as $project): ?>
                <div class="project-card owner-project-card">
                    <a href="edit-project.php?id=<?= (int)$project["id"] ?>" class="project-edit-btn" title="Projeyi Düzenle" aria-label="Projeyi Düzenle">
                    ...
                    <div class="card-body">
                        <?php if (!empty($project["expires_at"])): ?>
                            <div class="ilanda-badge" style="margin-bottom: 12px;">
