...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($error === "") {
        ...
        if (!$stmt->fetch()) {
            ...
            $_SESSION["success"] = "Proje ilanı başarıyla yayınlandı.";
...
<div class="register-container">
    ...
    <h2><i class="fa-solid fa-bullhorn"></i> Proje İlanı Oluştur</h2>
            ...
            <div class="form-group">
                ...
                <select id="project_id" name="project_id" required>
                    ...
                    <?php foreach ($myProjects as $p): ?>
                        <?php $pid = (int)$p["id"]; ?>
                        <option value="<?= $pid ?>" <?= ($selectedProjectId === $pid) ? "selected" : "" ?>>
                            <?= htmlspecialchars($p["title"]) . (empty($p["expires_at"]) ? "" : "  (İlan Yayında)") ?>
                        </option>
                    <?php endforeach; ?>
                </select>
