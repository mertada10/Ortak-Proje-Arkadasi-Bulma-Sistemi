            ...
            <?php foreach ($incoming as $request): ?>
                ...
                <div class="request-card">
                    ...
                    <div class="request-actions">
                        ...
                        <?php else: ?>
                            <form method="POST" class="request-action-form" data-request-id="<?= (int)$request["id"] ?>" data-status="accepted">
                            ...
                            <form method="POST" class="request-action-form" data-request-id="<?= (int)$request["id"] ?>" data-status="rejected">
                                <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
                                <input type="hidden" name="request_id" value="<?= (int)$request["id"] ?>">
