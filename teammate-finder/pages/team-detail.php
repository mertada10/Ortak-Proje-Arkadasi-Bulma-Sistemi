    ...
    <div class="team-shell">
        ...
        <section class="team-hero">
            ...
            <div class="team-hero-actions">
                ...
                <?php if ($team["owner_id"] == $_SESSION["user_id"]): ?>
                    <form method="POST" class="team-action-form team-dissolve-form" data-team-id="<?= (int)$team["id"] ?>">
                        <button
                            type="submit"
                            name="dissolve_team"
                ...
                <?php else: ?>
                    <form method="POST" class="team-action-form team-leave-form" data-team-id="<?= (int)$team["id"] ?>">
                        <button
                            type="submit"
                            name="leave_team"
